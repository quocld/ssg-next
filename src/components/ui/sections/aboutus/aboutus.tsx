...
export const metadata: Metadata = {
  title: 'About Us - SSG Landing Page',
  description: 'Learn more about our gaming platform, our community, and our mission to bring gamers together.',
  openGraph: {
    title: 'About Us - SSG Landing Page',
    description: 'Learn more about our gaming platform, our community, and our mission to bring gamers together.',
    type: 'website',
    ...
    <section aria-label="About Us Section" className='grid grid-cols-1 gap-10 px-0 pt-12 text-black md:pt-20 lg:grid-cols-2 lg:px-[5rem] xl:px-[10rem] xl:pt-[8rem] 2xl:px-[23.75rem]'>
      ...
      <div className='mt-[0.9375rem] flex flex-col items-center justify-center lg:mt-[4.25rem]'>
        <Image
          ...
          title='Gaming Witch Character'
          loading="eager"
        />
        <Image
          className='z-0'
          alt='Interactive World Map for Gaming Platform'
          src={PATH_IMAGE.MAP}
          width={1160}
          height={428}
          priority
          quality={90}
          sizes="100vw"
          title='Interactive World Map for Gaming Platform'
          loading="eager"
        />
      </div>
    </section>
